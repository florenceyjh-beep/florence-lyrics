...
import { getVocabulary } from "@/lib/lessons";
  ...
  return (
    <div className="space-y-5">
      <PageHero
        ...
        description="A unified vocabulary bank generated from every lesson JSON file."
      />
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
        {vocabulary.map((entry) => (
          <Link
            key={`${entry.lessonId}-${entry.term}-${entry.reading}`}
