...
import { getGrammarPoints } from "@/lib/songs";
  ...
  return (
    <div className="space-y-5">
      <PageHero
        ...
        description="Grammar points are collected across song sections while staying linked to their lyric context."
      />
      <div className="space-y-3">
        {grammar.map((point) => (
          <Link
            key={`${point.songId}-${point.sectionId}-${point.title}`}
            href={`/song/${point.songId}#${point.sectionId}`}
